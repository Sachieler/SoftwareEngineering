...
import org.fkit.hrm.dao.AdviceDao;
import org.fkit.hrm.dao.DetectDao;
...
public class HrmServiceImpl implements HrmService{
	...
	@Override
	public List<Detect> findDetect(Detect detect, PageModel pageModel) {
		/** 当前需要分页的总数据条数  */
		Map<String,Object> params = new HashMap<>();
		params.put("detect", detect);
		int recordCount = detectDao.count(params);
		...
		List<Detect> detects = detectDao.selectByPage(params);
		 
		return detects;
	}

	/**
	 * HrmService接口findDetectById方法实现
	 * @see { HrmService }
	 * */
	@Transactional(readOnly=true)
	@Override
	public Detect findDetectById(Integer id) {
		return null;
		//return detectDao.selectById(id);
	}

	/**
	 * HrmService接口removeDetectById方法实现
	 * @see { HrmService }
	 * */
	@Override
	public void removeDetectById(Integer id) {
		//detectDao.deleteById(id);
		
	}
	
	/**
	 * HrmService接口addDetect方法实现
	 * @see { HrmService }
	 * */
	@Override
	public void addDetect(Detect detect) {
		detectDao.save(detect);
		
	}
	
	/**
	 * HrmService接口modifyDetect方法实现
	 * @see { HrmService }
	 * */
	@Override
	public void modifyDetect(Detect detect) {
		detectDao.update(detect);
...
/*****************反馈接口实现*************************************/
	@Transactional(readOnly=true)
	@Override
	public List<Advice> findAdvice(Advice advice, PageModel pageModel) {
		/** 当前需要分页的总数据条数  */
		Map<String,Object> params = new HashMap<>();
		params.put("advice", advice);
		int recordCount = adviceDao.count(params);
		pageModel.setRecordCount(recordCount);
		...
		List<Advice> advices = adviceDao.selectByPage(params);
		 
		return advices;
	}

	/**
	 * HrmService接口findAdviceById方法实现
	 * @see { HrmService }
	 * */
	@Transactional(readOnly=true)
	@Override
	public Advice findAdviceById(Integer id) {
		...
		return adviceDao.selectById(id);
	}

	/**
	 * HrmService接口removeAdviceById方法实现
	 * @see { HrmService }
	 * */
	@Override
