...
public interface EmployeeDao {
	...
	@Results({
		@Result(id=true,column="productnumber",property="productnumber"),
		@Result(column="productname",property="productname"),
		@Result(column="data1",property="data1"),
		@Result(column="data1result",property="data1result"),
		@Result(column="data2",property="data2"),
		@Result(column="data2result",property="data2result"),
		@Result(column="result",property="result"),
		@Result(column="testtime",property="testtime",javaType=java.util.Date.class)
	})
